...
description: "在将博客从 Hexo 迁移到 Astro 并完成基础搭建后，我为新博客加入了评论功能。最初沿用熟悉的 Twikoo，但在实际使用中发现 Giscus 更加便捷高效。它将评论数据托管在 GitHub Discussions，无需额外数据库，且支持邮件提醒，管理更轻松。本文分享完整的配置流程与代码示例，帮助你快速在 Astro 博客中接入 Giscus，打造简洁实用的互动体验。"
date: "Aug 20 2025"
---
